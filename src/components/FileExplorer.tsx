              ...
              {isGitRepo && (
                <>
                  {gitStatus && gitStatus.behind > 0 && !forcePullConfirm && (
                    ...
                    >
                      {isOnMain ? (
                        <svg width="20" height="20" viewBox="0 0 16 16" fill="none" stroke="var(--text-secondary)" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.7, ...(syncing ? { animation: "spin 1s linear infinite" } : undefined) }}>
                          <path d="M8 3v10" strokeWidth="1.5" />
                          <path d="M4 9l4 4 4-4" strokeWidth="1.5" />
                        </svg>
                      ) : (
                        <svg width="20" height="20" viewBox="0 0 16 16" fill="var(--text-secondary)" style={{ opacity: 0.7, ...(syncing ? { animation: "spin 1s linear infinite" } : undefined) }}>
