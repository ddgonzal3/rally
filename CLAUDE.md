...
- **No backdrop overlays on modals.** Never add a dark/blurred/semi-transparent backdrop behind popup modals or dialogs. No `background: rgba(0,0,0,0.5)`, no blur overlay, no dimming of the app behind modals. Modals should float over the app content without any background overlay.
